...
#
#   - run:     array 0-119 (dataset x few_shot x seed) su scripts/slurm/vitb_vitl_trace.sbatch
...
# Log: .log/vitb_vitl_trace/
set -euo pipefail
cd "$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)"

EXP="vitb_vitl_trace"
CFG="configs/vision8_steer_trace_vitl/vision8_steer_trace_vitl_fs1_seed33.json"
